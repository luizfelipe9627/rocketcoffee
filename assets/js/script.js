...
window.onload = function () {
  document.querySelector(".menu-mobile").addEventListener("click", function () {
    if (document.querySelector(".menu nav").style.display == "flex") {
      ...
      document.querySelector(".menu-mobile").src = "./assets/image/menu-hamburguer-open.svg";
    } else {
      document.querySelector(".menu nav").style.display = "flex";
      document.querySelector(".menu-mobile").src = "./assets/image/menu-hamburguer-close.svg";
    }
  });
};
